...
public class Fragment_Complaints_Close extends Fragment implements Observer, DataHolder {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fragment__complaints__close, container, false);
        ...
        if (o instanceof ObjectTicketList) {
            if (objectTicketListComplaints.getTicketListResponse().getSuccess()) {
                ...
                for (int i = 0; i < objectTicketListComplaints.getTicketListResponse().getData().size(); i++) {
                    if (objectTicketListComplaints.getTicketListResponse().getData().get(i).getTicketStatus().equals("1")) {
